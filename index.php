...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-sm bg-body-tertiary sticky-top">
    <div class="container">
      <a class="navbar-brand" href="#">Boss Muda</a>
      <button
...
<section id="hero" class="text-center p-5 bg-danger-subtle text-sm-start">
    <div class="container">
      <div class="d-sm-flex flex-sm-row-reverse align-items-center">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ9Ehom35mOcEuyX9xXa1PytQebktbWg8bYkw&s" class="img-fluid" width="300" />
        <div>
          <h1 class="fw-bold display-4">
            Website tentang informasi MOBIL
          </h1>
          <h4 class="lead display-6">
            CUMI DARAT MOMENT IS GOOD
          </h4>
          <h6>
...
<!-- article end -->
    ...
    <div class="container">
      <div class="d-sm-flex align-items-center justify-content-center">
        ...
        <div class="p-md-5 text-sm-start">
          <h3 class="lead">A11.2023.14935
          </h3>
          <h1 class="fw-bold">Antonius Bogi Vieri</h1>
 ...
 <footer id="footer" class="text-center p-5">
  ...
  <div>Antonius Bogi Vieri&copy; 2024</div>
</footer>
<!-- footer end -->
